...
3. How often was the elective failure-to-deliver EoD (10(a)(ii)) switched on, and for which markets (e.g. USTs vs EGBs vs EM collateral)? Did the dealer's standard Annex I elect it?
...
5. For large-asset-manager agency relationships: what did the manager's standard rider to the Agency Annex look like (per-principal netting, allocation deadlines, agent liability), and which of those points did the bank concede to smaller managers vs hold against large ones?
